...
export default function Header() {
    return (
        <header style={headerStyle}>
            ...
            <motion.img src='https://upload.wikimedia.org/wikipedia/tr/5/53/Rocky_balboa.jpeg' alt='avatar' style={avatarStyle} initial={{opacity: 0,x:100}} animate={{opacity:1,x:0}} />
